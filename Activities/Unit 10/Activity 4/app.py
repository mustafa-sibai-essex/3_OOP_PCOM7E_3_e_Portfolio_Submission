...
def add(x, y):
    ...
    addition = x + y
    assert addition == x + y, "The operation performed is not addition"
    return addition
...
def subtract(x, y):
    ...
    subtraction = x - y
    assert subtraction == x - y, "The operation performed is not subtraction"
    return subtraction
...
def multiply(x, y):
    ...
    multiplication = x * y
    assert multiplication == x * y, "The operation performed is not multiplication"
    return multiplication


def divide(x, y):
    """Divides two numbers"""
    assert y > 0, "Cannot devide by zero"

    division = x / y
    assert division == x / y, "The operation performed is not division"
    return division
